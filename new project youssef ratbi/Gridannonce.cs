...
{
    public partial class Gridannonce : Form
    {
        ...
        private void Gridannonce_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!quartierFound)
                {
                    MessageBox.Show("Annonce n'existe pas!");
                    return;
                }
        ...
        private void Gridannonce_Load_1(object sender, EventArgs e)
        {
            cnx.Open();
