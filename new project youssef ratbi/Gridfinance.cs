...
{
    public partial class Gridfinance : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                // First query: Select from Finance
                ...
                if (!quartierFound)
                {
                    MessageBox.Show("Finance n'existe pas!");
                    return;
                }
        ...
        private void Gridfinance_Load(object sender, EventArgs e)
        {
            cnx.Open();
