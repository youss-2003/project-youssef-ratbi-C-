...
{
    public partial class Gridroles : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                // First query: Select from Rôles
                cmd.CommandText = "select * from Rôles";
                dr = cmd.ExecuteReader();
                ...
                if (!quartierFound)
                {
                    MessageBox.Show("Rôle n'existe pas!");
                    return;
                }
        ...
        private void Gridroles_Load(object sender, EventArgs e)
        {
            cnx.Open();
