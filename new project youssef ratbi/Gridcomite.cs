...
{
    public partial class Gridcomite : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "select * from Comité";
                dr = cmd.ExecuteReader();
                ...
                if (!quartierFound)
                {
                    MessageBox.Show("Comité n'existe pas!");
                    return;
                }
        ...
        private void Gridcomite_Load(object sender, EventArgs e)
        {
            cnx.Open();
